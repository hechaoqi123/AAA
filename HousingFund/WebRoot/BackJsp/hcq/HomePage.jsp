...
-->
							...
							<li class="">
								<a href="unitInfo.jsp" target="right_main">
							...
							<li class="">
								<a href="unitInfo_check.jsp" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									单位开户审批
								</a>
							...
							<li class="">
								<a href="unitInfo_end.jsp" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									公积金开户登记
								</a>
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							<i class="menu-icon fa fa-desktop"></i>
							<span class="menu-text">个人 业务</span>
							<b class="arrow fa fa-angle-down"></b>
						</a>
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="../BackJsp/LoanApplication.jsp" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									  贷款申请书
								</a>
							...
							<li class="">
								<a href="showlendApproval.action" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									贷款资格信息审批
								</a>
							...
							<li class="">
								<a href="assureAssess.action" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									贷款担保价值评估
								</a>
							...
							<li class="">
								<a href="review.action" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									贷款终审
								</a>
								...
								<li class="">
								<a href="LoanPact.jsp" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									签订借贷合同
								</a>
							...
							<li class="">
								<a href="return_loan.jsp" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									按揭偿还贷款
								</a>
							...
							<li class="">
								<a href="push_Loan.jsp" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									冲贷业务办理
								</a>
							...
							<li class="">
								<a href="Refund.jsp" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									领结贷款清单
								</a>
							...
							<li class="">
								<a href="before_return_loan.jsp" target="right_main">
									<i class="menu-icon fa fa-caret-right"></i>
									提前还款申请书
								</a>
			...
			<div class="main-content">
				...
				<div class="page-content">
					<iframe src="hcq/push_Loan.jsp" name="right_main" frameborder="0" scrolling="auto" width="100%" height="2000px"></iframe> 
				</div>
			</div>
		</div><!-- /.main-container -->
