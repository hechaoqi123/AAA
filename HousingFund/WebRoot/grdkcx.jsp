...
<html>
  <head>
    ...
    <title>My JSP 'grdkcx.jsp' starting page</title>
...
<ul>
<li>身份证号:&nbsp&nbsp<input type="text"  id="zh"  style="width:270px;height:32px;border:1.5px solid #747474;"></li>
<li>查询密码:&nbsp&nbsp<input type="password" style="width:270px;height:32px;border:1.5px solid #747474;"></li>
             ...
             $("#myTab").html('');
                 for(var i=0;i<data.list.length;i++){
                   ...
                   $("#myTab").append(tr);
                    ...
                    window.location.href="loanshow.jsp?bo="+zh;
                    }
                 },
                 error:function(date){
                 alert("输入信息有误，请重新输入");
