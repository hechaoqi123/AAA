...
<div style="width: 100%;height:48px;background-color:#318cd4;margin-top:0px;" id="topmenu">
  <ul id="topmenuul">
   <a href="#"><li style="background-color: #016ec5">首页</li></a>
    ...
    <div id="zhong">
 <div id="lunboleft" style="width:335px;height:250px;border:0px solid #000;margin-left:670px;padding-top:60px;">

 <a href="grzfcx.jsp"> <div id="shang">
  <p style="margin-top:-29px;margin-left:19px;color:white;">个人住房公职金查询</p>
  </div></a>
   <a href="grdkcx.jsp">
  <div id="xia">
    <p style="margin-top:-29px;margin-left:19px;color:white;">个人贷款查询</p>
  </div></a>
  </div>
    </div>
